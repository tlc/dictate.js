...
function export16kMonoWAV(type){
  var buffer = mergeBuffers(recBuffers, recLength);
  var r2 = new Resampler(sampleRate, 16000, 1, recLength);
  var samples = r2.resampler(buffer);
  var dataview = encodeWAV(samples, 16000);
  var audioBlob = new Blob([dataview], { type: type });
...
function encodeWAV(samples, sampleRate){
  ...
  var numChannels = 1;        /* this is all mono */
